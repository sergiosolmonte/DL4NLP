...
def train(model, train_data, val_data, learning_rate, epochs, label):
...
def evaluate(model, test_data):
    ...
    with torch.no_grad():
        ...
        for test_input, test_label in test_dataloader:
              ...
              """ It is for bert-base-german-case
              ...
              y_true.append( np.argmax(output.logits[0]))
              y_true.append(np.argmax(output.logits[1]))
