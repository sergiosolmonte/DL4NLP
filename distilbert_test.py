...
print("Training: ")
train(model, df_train, df_val, LR, EPOCHS, 'mybert.pkl') #we update the saved model after every epoch (see line 129-130 of models.py)
...
#train(model, df_train,df_val,LR,EPOCHS,'berthistorical.pkl')
